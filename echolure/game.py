...
class Game:
    ...
    def draw_title_screen(self):
        ...
        rules = [
            ("核心规则", WHITE, 220),
            ("", None, 0),
            ("\"量子共振晶体\"是一种处于宏观叠加态的外星物质。", LIGHT_GRAY, 255),
            ("搭载该晶体的目标在未被特定频率声波\"观测\"时，", LIGHT_GRAY, 280),
            ("将处于视觉隐形与物理叠加态，如同深海中的量子幽灵。", LIGHT_GRAY, 305),
            ("", None, 0),
            ("量子声呐炮驻扎在漆黑的深海监听站，", LIGHT_GRAY, 345),
            ("定时定向发射声呐雷达搜索目标。", LIGHT_GRAY, 370),
            ("目标被声呐扫到后显形0.5s，随即受惊逃逸。", LIGHT_GRAY, 395),
            ("", None, 0),
            ("操作方式", WHITE, 440),
            ("", None, 0),
            ("• 鼠标移动：控制炮台瞄准方向", LIGHT_GRAY, 475),
            ("• 空格：发射包裹着纠缠态声子的\"坍缩脉冲\"", LIGHT_GRAY, 500),
            ("• 目标在显形状态下被击中会塌缩消散，获得积分", LIGHT_GRAY, 525),
            ("", None, 0),
            ("道具系统", WHITE, 570),
            ("", None, 0),
            ("• 黄色光球为特殊道具，有多种不同的效果", LIGHT_GRAY, 605),
            ("• 全频扫描：下一次声呐变为360°全屏扫描", LIGHT_GRAY, 635),
            ("• 黏着信标：下一次命中标记目标6秒", LIGHT_GRAY, 665),
            ("• 跳弹散芯：下一次反弹后分裂为3发弹片", LIGHT_GRAY, 695),
        ]
